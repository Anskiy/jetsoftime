...
def randomize_keys(char_locs,outfile):
    ...
    if iterations == 3600:
       ...
       "melchior" ,"claw" ,"desert" ,"arris" ,"geno" ,"sun" ,"reptite" ,"woe"]
       pointer1 = [0x393C82,0x35F8AE,0x37742F,0x380C42,0x3891D5,0x3966B,0x38045D,0x3805DE,0x1B8AEC,
       0x6EF5E,0x392F4C,0x1B1844,0x1B8D95,0x18FC2C,0x381010]
       pointer2 = [0x393C84,0x35F8B0,0x377432,0x380C5B,0x3891D7,0x3966D,0x38045F,0x3805E0,
