...
shop_starts = range(0xC2C6D,0xC2C9D,2)
regular_shops = [0xC2C6D,0xC2C6F,0xC2C73,0xC2C77,0xC2C79,0xC2C85] + range(0xC2C89,0xC2C91,2)
...
midarmors = [0x80,0x81,0x82,0x83,0x84,0x85,0x87,0x88,0x8C,0x8D,0x60,0x61,0x62,0x63,0x64,0x65,0x66,0x67]
midaccies = [0xAB,0xA7,0x9C,0x9E,0xB6,0xB4,0x9D,0xA0]
midconsumes = [0xBE,0xC0,0xC1,0xC7,0xC8]
highweapons = [0x08,0x09,0x0A,0x0B,0x10,0x16,0x17,0x25,0x26,0x34,0x35,0x3E,0x3F,0x4B]
higharmors = [0x8B,0x8E,0x89,0x79,0x75,0x76,0x77,0x78,0x68,0x69,0x6E,0x6F]
